...
CNN_MODEL_DIR = "model/CNN/3cnn_test.ckpt"
    ...
    for i in range(num_epochs):
      ...
      for batch_idx in range(int(num_datapoint/batch_size)):
        ...
        if batch_idx % 100 == 0:
          ...
          print('Epoch %d, batch_idx %d, training accuracy %g' % (i,batch_idx ,train_accuracy))
        train_step.run(feed_dict={x: images[start_idx:end_idx], y_: labels[start_idx:end_idx], keep_prob: 0.8})
